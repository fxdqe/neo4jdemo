!function (e) {
  ...
  $('[data-toggle="tooltip"]').tooltip(), $(document).ready(function () {
    ...
    return $("#pageTour").modal("hide").on("hidden.bs.modal", function (e) {
      var o = new EnjoyHint({});
      o.set([{'next [data-target="#write"]': "٩( ๑╹ ꇴ╹)۶ s在这里和Cortana进行问答.如果想使用关键字查询，请用（）将它括起来"},{'next [data-target="#card"]': "这里可以查看Cortana的资料."},{'next [data-navigation-target="Authors"]': "这里你会看到两位作者."},{'next [data-navigation-target="References"]': "这里是我们的一些参考资料."},{'next [data-target="#Darkmode"]': "点这里开启夜间模式."},{'next [data-target="#Usermenu"]': "这里是还没做好（根本不打算做）的用户菜单."}])
      o.run()
    }), !1
  })
});
